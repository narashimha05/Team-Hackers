...
const RegisterSponsor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://team-hackers.onrender.com/v1/api/register-sponsor', formData);
      ...
      console.error('There was an error registering the sponsor:', error.response || error.message);
    }
  };

  return (
    <div className="max-w-md mx-auto bg-white shadow-md rounded-md p-6">
      <h2 className="text-2xl font-bold mb-6">Register Sponsor</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label className="block text-gray-700">Amount to be Sponsored</label>
          <input 
            type="number" 
            value={amount} 
